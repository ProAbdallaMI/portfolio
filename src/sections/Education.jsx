	...
	return (
		<section className="flex flex-col gap-5 justify-center items-center">
			...
			<p className="text-paragraph w-70/100 text-center">
				Education has given me the foundation to think critically, solve
				problems, and keep learning. It has opened opportunities for me
				to grow personally and professionally toward my career goals.
			</p>
